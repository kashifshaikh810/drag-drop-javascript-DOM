...
var dragdivs = document.querySelectorAll("#drag-container div");
var dropdivs = document.querySelectorAll("#drop-container div");
Array.from(dragdivs).forEach(function (dragdiv) {
  dragdiv.addEventListener("dragstart", function (e) {
    e.target.classList.add("dragging");
    e.dataTransfer.effectAllowed = "move";
    var className = e.target.getAttribute("data-image");
    e.dataTransfer.setData("text/plain", className);
  });
  dragdiv.addEventListener("dragend", function (e) {
    e.target.classList.remove("dragging");
    e.target.remove();
  });
});
Array.from(dropdivs).forEach(function (dropdiv) {
  ...
  dropdiv.addEventListener("drop", function (e) {
    e.stopPropagation();
    var className = e.dataTransfer.getData("text/plain");
...
//# sourceMappingURL=/drag-drop-html5.e31bb0bc.js.map